(function()
{
	...
	spsupport.api = {
		...
		jQLoaded: function()
		{
			...
			// Cars a/b test
			if (testBucket == '2014w19_cars_v1' && similarproducts.b.userData.uc == 'US' && (similarproducts.utilities.blacklistHandler.isCarsDomainWhiteList() || similarproducts.b.qsObj['debug']))
			{
		...
		normalFlow: function()
		{
			...
			if (!spsupport.sites.isBlackStage())
			{
				...
				{*/
					...
					if (testBucket == 'OldUI_Holdback' || similarproducts.b.userData.uc == 'ES' || dlsource == 'conduit' || dlsource == 'conduit2' || dlsource == 'conduit3' || dlsource == 'specialsavings_tb')
					{
						similarproducts.b.oldUI = true;
					}


					/*if (!similarproducts.b.oldUI && (testBucket == '2014w16_UIv7_Arrow_Orange_Carat'))
					{
						similarproducts.b.inj(document, sp.sfDomain+'css/main_test.css?v='+similarproducts.b.appVersion);
					}
					else*/ if (similarproducts.b.oldUI)
					{
						similarproducts.b.inj(document, spsupport.p.sfDomain+'css/main_old.css?v='+similarproducts.b.appVersion);
					}
					else
					{
